...
/**
 * Protobuf type {@code com.zwy.proto.MyResponse}
 */
public  final class MyResponse extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:com.zwy.proto.MyResponse)
    MyResponseOrBuilder {
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return StudentProto.internal_static_com_zwy_proto_MyResponse_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return StudentProto.internal_static_com_zwy_proto_MyResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            MyResponse.class, Builder.class);
  }

  public static final int RELANAME_FIELD_NUMBER = 2;
  private volatile Object relaname_;
  /**
   * <code>string relaname = 2;</code>
   * @return The relaname.
   */
  public String getRelaname() {
    Object ref = relaname_;
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (!getRelanameBytes().isEmpty()) {
      com.google.protobuf.GeneratedMessageV3.writeString(output, 2, relaname_);
    }
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (!getRelanameBytes().isEmpty()) {
      size += com.google.protobuf.GeneratedMessageV3.computeStringSize(2, relaname_);
    }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!getRelaname()
        .equals(other.getRelaname())) return false;
  ...
  public int hashCode() {
    ...
    hash = (37 * hash) + RELANAME_FIELD_NUMBER;
    hash = (53 * hash) + getRelaname().hashCode();
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:com.zwy.proto.MyResponse)
      MyResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return StudentProto.internal_static_com_zwy_proto_MyResponse_descriptor;
    ...
    // Construct using com.zwy.proto.MyResponse.newBuilder()
    private Builder() {
    ...
    public Builder mergeFrom(MyResponse other) {
      ...
      if (!other.getRelaname().isEmpty()) {
        relaname_ = other.relaname_;
        onChanged();
      }
    ...
    /**
     * <code>string relaname = 2;</code>
     * @param value The relaname to set.
     * @return This builder for chaining.
     */
    public Builder setRelaname(
        String value) {
      if (value == null) {
    throw new NullPointerException();
  }
     ...
     * @return This builder for chaining.
     */
    public Builder clearRelaname() {
      
      relaname_ = getDefaultInstance().getRelaname();
      onChanged();
      return this;
    }
    /**
     * <code>string relaname = 2;</code>
     * @param value The bytes for relaname to set.
     * @return This builder for chaining.
     */
    public Builder setRelanameBytes(
  ...
  checkByteStringIsUtf8(value);
    ...
    // @@protoc_insertion_point(builder_scope:com.zwy.proto.MyResponse)
  }

  // @@protoc_insertion_point(class_scope:com.zwy.proto.MyResponse)
